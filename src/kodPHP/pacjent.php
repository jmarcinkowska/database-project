      ...
      <div class="row">
        ...
        <div class="col-md-4">
          <div class="card">
            ...
            <div class="card-body">
              <center>
              <h5>Panel pacjenta</h5><br>
              <form class="form-group" method="post" action="pacjent_check.php">
                <div class="row">
                  <div class="col-md-4"><label>Login: </label></div>
                  <div class="col-md-8"><input type="text" name="login" class="form-control" placeholder="wprowadź login" required value="login"/></div><br/><br/>
                  <div class="col-md-4"><label>Hasło: </label></div>
                  <div class="col-md-8"><input type="password" class="form-control" name="haslo" placeholder="wprowadź hasło" required value="haslo"/></div><br><br>
                </div>
                <center><input type="submit" id="inputbtn" name="login_submit" value="Zaloguj" class="btn btn-primary"></center>
                Nie masz jeszcze konta?<br>
    <a href="nowy_pacjent.php" class="rejestracja">Zarejestruj się</a>
              </form>
            </center>
            </div>
          </div>
